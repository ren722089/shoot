...
<form action="" method="post">
    ...
    <body>
        ...
        <p><input type="text" name="pass1" placeholder="パスワードを入力してください" value="<?php if (isset($edname) && isset($edcomment)) {
                                                                                    echo $edpass;
                                                                                } ?>"></p>
        ...
        <p><input type="text" name="pass2" placeholder="パスワードを入力してください"></p>
        <p><button type="submit" name="submit2">削除</button></p>

        <p>【編集フォーム】</p>
        <p><input type="number" name="edit" placeholder="編集したい番号を選んでください"></p>
        <p><input type="text" name="pass3" placeholder="パスワードを入力してください"></p>
